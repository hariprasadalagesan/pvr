        ...
        >
          ...
          >
            <button
              ...
              className={`px-3.5 py-1.5 rounded text-xs font-mono font-medium transition-all duration-150 focus:outline-none focus-visible:ring-2 focus-visible:ring-accent cursor-pointer ${
                activeCategoryId === 'all'
            ...
            {technologyCategories.map((cat) => {
              ...
              return (
                <button
                  ...
                  className={`px-3.5 py-1.5 rounded text-xs font-mono font-medium transition-all duration-150 flex items-center gap-1.5 focus:outline-none focus-visible:ring-2 focus-visible:ring-accent cursor-pointer ${
                    isSelected
                      ? cat.isResearch
